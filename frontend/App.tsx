...
import {
  ...
  BehaviorRiskCalculatorPage, LiteComplianceQuizPage, StandardRiskCalculatorPage
    ...
    <>
      <Routes>
        ...
        <Route element={<PublicLayout />}>
          ...
          <Route path="/compliance-audit" element={<StandardRiskCalculatorPage />} />
        </Route>
        ...
        {/* Emergency Rescue Route - Unprotected */}
