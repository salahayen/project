      ...
      <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24 bg-white relative">
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <a
                ...
                className="w-full inline-flex justify-center py-2.5 px-4 border border-gray-200 rounded-xl shadow-sm bg-white text-sm font-bold text-gray-600 hover:bg-gray-50 hover:border-gray-300 transition-all no-underline items-center"
              >
          ...
          <div className="mt-2 text-center">
            <a href="/#/rescue" className="text-xs text-red-500 hover:text-red-600 underline decoration-dotted">
              System Locked? Emergency Rescue
            </a>
          </div>
        </div>
      </div>
