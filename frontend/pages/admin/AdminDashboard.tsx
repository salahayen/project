                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex gap-2">
                        <Button
                            ...
                            onClick={async () => {
                                if (!window.confirm('Fix Database Schema? Use this if you see "Column does not exist" errors.')) return;
                                try {
                                    ...
                                    if (res.ok) {
                                        alert('Schema Fixed! Output: ' + (data.output || 'Success'));
                                    } else {
                                        alert('Failed: ' + data.details);
                                    }
                                } catch (e) { console.error(e); alert('Error migrating'); }
                            }}
                        >
                            <Zap size={14} className="mr-1" /> Fix Schema
                        </Button>

                        <Button
                            size="sm"
                            variant="outline"
                            className="bg-red-50 text-red-600 border-red-100 hover:bg-red-100 font-bold"
                            onClick={async () => {
                                if (!window.confirm('Reset and Seed Database? This will wipe data and repopulate defaults.')) return;
                                try {
                                ...
                                } catch (e) { console.error(e); alert('Error seeding'); }
                            }}
                        >
                            <Trash2 size={14} className="mr-1" /> Reset DB
                        </Button>
                    </div>
