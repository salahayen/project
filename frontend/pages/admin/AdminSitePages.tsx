                ...
                <Card className="flex-1 flex flex-col p-0 overflow-hidden border-gray-200 shadow-sm">
                    <div className="p-4 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                        ...
                        <div className="flex gap-2">
                            {pages.length === 0 && (
                                <Button size="sm" variant="ghost" onClick={handleReset} title="Initialize Defaults" className="h-8 w-8 p-0 text-orange-500 hover:text-orange-600 hover:bg-orange-50">
                                    <RotateCw size={14} />
                                </Button>
                            )}
