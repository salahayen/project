...
const PaymentPage = () => {
    const { user, addRequest, updateRequestStatus, t, language, plans, services } = useAppContext();
            ...
            if (planId) {
                ...
                if (service) {
                    setPendingRequest({
                        ...
                        dateCreated: new Date().toISOString(),
                        description: `Booking Service: ${service.nameEn}`,
                        batches: []
                    });
                }
            }
        }
    }, [planId, serviceId, billingCycle, user, pendingRequest, plans, services]);
