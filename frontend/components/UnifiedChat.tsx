            ...
            {activeTab === 'AI' ? (
              ...
              <>
                ...
                <div className="flex flex-col gap-3 mt-4">
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest px-1">{t('chat.quickQuestions') || 'Quick Questions'}</p>
                  <div className="flex flex-wrap gap-2">
                    {[
                      { label: t('chat.packagePrices') || 'Package Prices', path: '/pricing' },
                      { label: t('chat.howToRegister') || 'How to Register?', path: '/register' },
                      { label: t('chat.complianceCheck') || 'Compliance Risk Check', path: '/risk-calculator' },
                      { label: t('chat.ourServices') || 'Our Services', path: '/services' }
                    ].map((q, i) => (
                      <button
                        key={i}
                        onClick={() => {
                        ...
                        className="px-3 py-1.5 bg-white border border-slate-200 rounded-full text-[11px] font-medium text-slate-600 hover:border-primary-500 hover:text-primary-600 transition-all shadow-sm active:scale-95"
                      >
                        {q.label}
                      </button>
                    ))}
